...
public class EmpDaoImpl implements EmpDao {
	...
	public List<Emp> findByStartEnd(int start, int end) {
		...
		return session.selectList("com.example.demo.dao.EmpDao.findByStartEnd", map);
	}
	...
	public List<Emp> findBySkipLimit(int skip, int limit) {
		...
		return session.selectList("com.example.demo.dao.EmpDao.findBySkipLimit", map);
	}
	...
	public List<Emp> findByPageSize(int page, int size) {
		...
		return session.selectList("com.example.demo.dao.EmpDao.findByPageSize", map);
	}
