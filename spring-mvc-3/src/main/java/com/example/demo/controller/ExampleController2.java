...
public class ExampleController2 {
	...
	public String step2(@ModelAttribute Member member, HttpSession session) {
		...
		// 출력 : Member(name=tom, address=주소를 입력하세요)
	...
	// 1. 세션어트리뷰에 저장된 값을 member 객체에 할당됩니다. 이 때, name 값이 할당됩니다.
	...
	public String step3(
			...
			BindingResult result, 							// 사용자가 보낸 데이터와 관련한 에러데이터
			HttpSession session,
		...
		System.out.println(session.getAttribute("member"));
		// 출력 : Member(name=tom, address=seoul)
