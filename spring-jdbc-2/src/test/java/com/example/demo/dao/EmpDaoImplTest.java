...
// 작성하는 클래스내에서 클래스명은 생략하고 바로 스테틱메소드를 사용할 수 있다.
...
public class EmpDaoImplTest {
	...
	public void testInsert() {
		...
		System.out.println("전: " + emp);					// empno 값은 0인상태
	...
	public void testFindAll() {
		dao.findAll().forEach(System.out::println); // 리스트의 길이만큼 그대로 출력
	}
